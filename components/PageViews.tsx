...
export function FAQPage({ locale, dict }: { locale: Locale; dict: Dictionary }) { return <><PageHero eyebrow={dict.faq.eyebrow} title={dict.faq.title} /><FAQAccordion dict={dict} showHeading={false} /><ContactCTA locale={locale} dict={dict} /></>; }
