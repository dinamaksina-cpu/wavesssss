...
export const bookingTranslations: Record<Locale, {
  ...
  en: {
    quickIntro: "Send your contact details securely. We will email you a copy and contact you to confirm the service.", name: "Name", phone: "Phone number", email: "Email", confirmEmail: "Confirm email", namePlaceholder: "Your name", phonePlaceholder: "+357 97 579867 / +44 7911 123456", emailPlaceholder: "you@example.com",
  ...
  ru: {
    quickIntro: "Безопасно отправьте контактные данные. Мы пришлём копию на email и свяжемся с вами для подтверждения услуги.", name: "Имя", phone: "Номер телефона", email: "Email", confirmEmail: "Подтвердите email", namePlaceholder: "Ваше имя", phonePlaceholder: "+357 97 579867 / +44 7911 123456", emailPlaceholder: "you@example.com",
    customerDetails: "Ваши контактные данные", submitBooking: "Запросить бронирование", sendRequest: "Отправить запрос", submitting: "Отправка…", required: "Заполните все обязательные поля.", invalidPhone: "Введите корректный номер с кодом страны, например +357 97 579867 или +44 7911 123456.", invalidEmail: "Введите корректный email.", emailMismatch: "Адреса email не совпадают.",
  ...
  el: {
    quickIntro: "Στείλτε με ασφάλεια τα στοιχεία σας. Θα σας στείλουμε αντίγραφο με email και θα επικοινωνήσουμε για επιβεβαίωση της υπηρεσίας.", name: "Όνομα", phone: "Τηλέφωνο", email: "Email", confirmEmail: "Επιβεβαίωση email", namePlaceholder: "Το όνομά σας", phonePlaceholder: "+357 97 579867 / +44 7911 123456", emailPlaceholder: "you@example.com",
    customerDetails: "Τα στοιχεία επικοινωνίας σας", submitBooking: "Αίτημα κράτησης", sendRequest: "Αποστολή αιτήματος", submitting: "Αποστολή…", required: "Συμπληρώστε όλα τα υποχρεωτικά πεδία.", invalidPhone: "Εισαγάγετε έγκυρο αριθμό με κωδικό χώρας, π.χ. +357 97 579867 ή +44 7911 123456.", invalidEmail: "Εισαγάγετε έγκυρη διεύθυνση email.", emailMismatch: "Οι διευθύνσεις email δεν ταιριάζουν.",
  ...
  uk: {
    quickIntro: "Безпечно надішліть контактні дані. Ми надішлемо копію на email і зв’яжемося з вами для підтвердження послуги.", name: "Ім’я", phone: "Номер телефону", email: "Email", confirmEmail: "Підтвердіть email", namePlaceholder: "Ваше ім’я", phonePlaceholder: "+357 97 579867 / +44 7911 123456", emailPlaceholder: "you@example.com",
    customerDetails: "Ваші контактні дані", submitBooking: "Запросити бронювання", sendRequest: "Надіслати запит", submitting: "Надсилання…", required: "Заповніть усі обов’язкові поля.", invalidPhone: "Введіть коректний номер з кодом країни, наприклад +357 97 579867 або +44 7911 123456.", invalidEmail: "Введіть коректну email-адресу.", emailMismatch: "Email-адреси не збігаються.",
